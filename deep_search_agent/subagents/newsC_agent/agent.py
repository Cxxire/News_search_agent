"""
NewsC_agent
domain:etnet.com.hk "inews.hket.com"
"website:https://www.etnet.com.hk/www/tc/news/index.php" "https://inews.hket.com/"
"""
...
news_analyst = Agent(
    ...
    description="detail information search agent from one website only",
    ...
    Source Constraint: You are ONLY permitted to search the following two websites:
